...
content = content.replace("import { Mail, Instagram, Linkedin } from 'lucide-react';", "import { Mail, PhoneCall } from 'lucide-react';")

old_icons = '''<div className="flex items-center gap-3">
          ...
          <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors"><Linkedin className="w-4 h-4" /></a>
        </div>'''

new_icons = '''<div className="flex items-center gap-3">
          <a href="#" className="text-gray-400 hover:text-white transition-colors"><Mail className="w-4 h-4" /></a>
