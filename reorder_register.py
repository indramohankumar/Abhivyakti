...
def reorder_register_section(filename):
    ...
    # We simply swap the HTML blocks for the Card and the Tape, and adjust margins slightly.
...
target="_blank" rel="noopener noreferrer"
    ...
    with codecs.open(filename, 'w', encoding='utf-8') as f:
        f.write(content)
    print("Reordered register section!")

reorder_register_section('src/pages/Home.jsx')
